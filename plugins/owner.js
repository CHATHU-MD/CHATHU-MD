...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+94750893377'; // Replace this with the actual owner number
        const ownerName = 'CHATHU-MD'; // Replace this with the owner's name
        ...
        await conn.sendMessage(from, {
            text: `CHATHU-MD`,
            contextInfo: {
                mentionedJid: [ownerNumber.replace('94750893377') + '+94750893377@s.whatsapp.net'], // Mention the owner
